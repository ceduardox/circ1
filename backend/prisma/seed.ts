...
async function main() {
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day1.id, type: ContentType.VIDEO, title: 'El Poder de Tu Mente', content: { url: '/videos/day1.mp4', provider: 'direct', duration: 28, author: 'CollazoMcl', description: 'El poder de la sugestión: cómo moldea tu personalidad desde que naces. Aprende a usarlo a tu favor.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day2.id, type: ContentType.VIDEO, title: 'Cómo Cambiar tus Creencias', content: { url: '/videos/day2.mp4', provider: 'direct', duration: 56, author: 'CollazoMcl', description: 'Las leyes mentales que gobiernan tu comportamiento: la ley del hábito y la ley de la inercia.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day3.id, type: ContentType.VIDEO, title: 'El Poder de la Visualización', content: { url: '/videos/day3.mp4', provider: 'direct', duration: 11, author: '1% Imparable', description: 'Piensa en el éxito, obsesiónate con él, trabaja por él y el éxito llegará a ti.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day4.id, type: ContentType.VIDEO, title: 'La Regla de los 2 Minutos', content: { url: '/videos/day4.mp4', provider: 'direct', duration: 18, author: '1% Imparable', description: 'Disciplina: la base del éxito silencioso. No hace ruido, pero construye imperios.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day5.id, type: ContentType.VIDEO, title: 'El Secreto de los 90 Segundos', content: { url: '/videos/day5.mp4', provider: 'direct', duration: 40, author: 'CollazoMcl', description: 'El fracaso no existe: solo datos. No vincules tu identidad a los resultados.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day6.id, type: ContentType.VIDEO, title: 'La Regla 5 Segundos de Mel Robbins', content: { url: '/videos/day6.mp4', provider: 'direct', duration: 54, author: 'CollazoMcl', description: 'La ejecución diaria sin excusas: el hábito de quienes construyen algo grande desde cero.' }, orderIndex: 4, isRequired: true },
  ...
  await prisma.dayContent.createMany({ data: [
    ...
    { dayId: day7.id, type: ContentType.VIDEO, title: 'El Primer Día del Resto de tu Vida', content: { url: '/videos/day7.mp4', provider: 'direct', duration: 19, author: '1% Imparable', description: 'Mentalidad sin excusas: el cielo no es tu límite, es tu punto de partida.' }, orderIndex: 5, isRequired: true },
